<x-app-layout>
    <x-slot name="header">Edit Documentation Category</x-slot>

    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.documentation.categories.update', $category) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        @php $enTranslation = $category->translations->where('locale', 'en')->first(); @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('translations.en.name') is-invalid @enderror"
                                   id="translations_en_name" name="translations[en][name]"
                                   value="{{ old('translations.en.name', $enTranslation?->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.en.description') is-invalid @enderror"
                                      id="translations_en_description" name="translations[en][description]" rows="2">{{ old('translations.en.description', $enTranslation?->description) }}</textarea>
                        ...
                        @php $swTranslation = $category->translations->where('locale', 'sw')->first(); @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('translations.sw.name') is-invalid @enderror"
                                   id="translations_sw_name" name="translations[sw][name]"
                                   value="{{ old('translations.sw.name', $swTranslation?->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.sw.description') is-invalid @enderror"
                                      id="translations_sw_description" name="translations[sw][description]" rows="2">{{ old('translations.sw.description', $swTranslation?->description) }}</textarea>
