<x-app-layout>
    <x-slot name="header">Add Documentation Article</x-slot>

    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.documentation.articles.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       ...
                                       placeholder="e.g., how-to-create-products">
                                @error('slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('translations.en.title') is-invalid @enderror"
                                   id="translations_en_title" name="translations[en][title]" value="{{ old('translations.en.title') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.en.excerpt') is-invalid @enderror"
                                      ...
                                      maxlength="500" placeholder="Brief summary of the article">{{ old('translations.en.excerpt') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.en.content') is-invalid @enderror"
                                      id="translations_en_content" name="translations[en][content]" rows="10"
                                      placeholder="Article content (Markdown supported)" required>{{ old('translations.en.content') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('translations.sw.title') is-invalid @enderror"
                                   id="translations_sw_title" name="translations[sw][title]" value="{{ old('translations.sw.title') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.sw.excerpt') is-invalid @enderror"
                                      ...
                                      maxlength="500">{{ old('translations.sw.excerpt') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('translations.sw.content') is-invalid @enderror"
                                      id="translations_sw_content" name="translations[sw][content]" rows="10" required>{{ old('translations.sw.content') }}</textarea>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-1"></i>Create Article
                            </button>
